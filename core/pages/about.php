...
function seur_about_page(){ ?>
		<div class="wrap about-wrap">
			<h1><?php printf( esc_html__( 'Welcome to SEUR %s' ), esc_html( SEUR_OFFICIAL_VERSION ) ); ?></h1>
			<div class="about-text"><?php printf( esc_html__( 'Thank you for install Seur %s!', 'seur' ), esc_html( SEUR_OFFICIAL_VERSION ) ); ?></div>
			<div class="seur-badge"><?php printf( esc_html__( 'Version %s' ), esc_html( SEUR_OFFICIAL_VERSION ) ); ?></div>
