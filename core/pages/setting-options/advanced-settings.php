...
function seur_tipo_mercancia_field(){
   ...
   <select id="mercancia_type" name="seur_tipo_mercancia_field">
       <option value="C" <?php if ( $option == 'C') echo ' selected'; ?>><?php _e( 'C: Commercial', SEUR_TEXTDOMAIN ); ?></option>
       <option value="D" <?php if ( $option == 'D') echo ' selected'; ?>><?php _e( 'D: Documents', SEUR_TEXTDOMAIN ); ?></option>
       <option value="N" <?php if ( $option == 'N') echo ' selected'; ?>><?php _e( 'N: No Commercial', SEUR_TEXTDOMAIN ); ?></option>
       <option value="S" <?php if ( $option == 'S') echo ' selected'; ?>><?php _e( 'S: Envelopes', SEUR_TEXTDOMAIN ); ?></option>
    </select>
    <?php }
