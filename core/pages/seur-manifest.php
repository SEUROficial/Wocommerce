...
?>
        <div class="wp-filter">
            <label>
                <span class="screen-reader-text"><?php _e( 'From Date', 'seur' ); ?></span>
                <input id="datepicker" type='text' name='fechadesde' class="wp-filter-search" placeholder="<?php _e( 'From Date', 'seur' ); ?>" value=''>
            </label>
