...
<div class="container">
	...
	if ( ! isset( $_POST['seur_limit_price_weight_rates_post'] ) ) {
		...
		if ( isset( $_POST['seur_limit_price_weight_rates_post'] ) && ( ! isset( $_POST['seur_limit_price_weight_rates_nonce_field'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['seur_limit_price_weight_rates_nonce_field'] ) ), 'seur_limit_price_weight_rates' ) ) ) {
			...
			$seur_bc2_max_price_field                          = sanitize_text_field( wp_unslash( $_POST['seur_bc2_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_10e_max_price_field                          = sanitize_text_field( wp_unslash( $_POST['seur_10e_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_10ef_max_price_field                         = sanitize_text_field( wp_unslash( $_POST['seur_10ef_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_13e_max_price_field                          = sanitize_text_field( wp_unslash( $_POST['seur_13e_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_13f_max_price_field                          = sanitize_text_field( wp_unslash( $_POST['seur_13f_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_48h_max_price_field                          = sanitize_text_field( wp_unslash( $_POST['seur_48h_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_72h_max_price_field                          = sanitize_text_field( wp_unslash( $_POST['seur_72h_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_cit_max_price_field                          = sanitize_text_field( wp_unslash( $_POST['seur_cit_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_2shop_max_price_field                        = sanitize_text_field( wp_unslash( $_POST['seur_2SHOP_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_courier_int_aereo_paqueteria_max_price_field = sanitize_text_field( wp_unslash( $_POST['seur_courier_int_aereo_paqueteria_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_courier_int_aereo_documentos_max_price_field = sanitize_text_field( wp_unslash( $_POST['seur_courier_int_aereo_documentos_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
			$seur_netexpress_int_terrestre_max_price_field     = sanitize_text_field( wp_unslash( $_POST['seur_netexpress_int_terrestre_max_price_field'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
