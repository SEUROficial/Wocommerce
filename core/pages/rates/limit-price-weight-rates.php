                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td><input title="B2C Estándar" type="text" name="seur_bc2_max_price_field" value="<?php if ( $seur_bc2_max_price_field ) echo $seur_bc2_max_price_field ?>" size="40"></td>
                        </tr>

                        <tr>
                            <th scope="row">SEUR 10 Estándar</th>

                            <td><input title="SEUR 10 Estándar" type="text" name="seur_10e_max_price_field" value="<?php if ( $seur_10e_max_price_field ) echo $seur_10e_max_price_field ?>" size="40"></td>
                        </tr>

                        <tr>
                            <th scope="row">SEUR 10 Frío</th>

                            <td><input title="SEUR 10 Frío" type="text" name="seur_10ef_max_price_field" value="<?php if ( $seur_10ef_max_price_field ) echo $seur_10ef_max_price_field ?>" size="40"></td>
                        </tr>

                        <tr>
                            <th scope="row">SEUR 13:30 Estándar</th>

                            <td><input title="SEUR 13:30 Estándar" type="text" name="seur_13e_max_price_field" value="<?php if ( $seur_13e_max_price_field ) echo $seur_13e_max_price_field ?>" size="40"></td>
                        </tr>

                        <tr>
                            <th scope="row">SEUR 13:30 Frío</th>

                            <td><input title="SEUR 13:30 Frío" type="text" name="seur_13f_max_price_field" value="<?php if ( $seur_13f_max_price_field ) echo $seur_13f_max_price_field ?>" size="40"></td>
                        </tr>

                        <tr>
                            <th scope="row">SEUR 48H Estándar</th>

                            <td><input title="SEUR 48H Estándar" type="text" name="seur_48h_max_price_field" value="<?php if ( $seur_48h_max_price_field ) echo $seur_48h_max_price_field ?>" size="40"></td>
                        </tr>

                        <tr>
                            <th scope="row">SEUR 72H Estándar</th>

                            <td><input title="SEUR 72H Estándar" type="text" name="seur_72h_max_price_field" value="<?php if ( $seur_72h_max_price_field ) echo $seur_72h_max_price_field ?>" size="40"></td>
                        </tr>

                        <tr>
                            <th scope="row">Classic Internacional Terrestre</th>

                            <td><input title="Classic Internacional Terrestre" type="text" name="seur_cit_max_price_field" value="<?php if ( $seur_cit_max_price_field ) echo $seur_cit_max_price_field ?>" size="40"></td>
                        </tr>
