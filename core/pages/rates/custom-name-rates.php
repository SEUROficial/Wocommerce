	...
	<div class="container">
		...
		<div class="content-loader">
				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td><input title="<?php _e( 'Custom Name for ', 'seur' ); ?>COURIER INT AEREO DOCUMENTOS" type="text" name="seur_courier_int_aereo_documentos_custom_name_field" value="
							<?php
			...
			if ( isset( $_POST['seur_custom_name_rates_post'] ) && ( ! isset( $_POST['seur_custom_name_rates_nonce_field'] ) || ! wp_verify_nonce( $_POST['seur_custom_name_rates_nonce_field'], 'seur_custom_name_rates' ) ) ) {
				...
				$seur_bc2_custom_name                          = sanitize_text_field( wp_unslash( $_POST['seur_bc2_custom_name_field'] ) );
				$seur_10e_custom_name                          = sanitize_text_field( wp_unslash( $_POST['seur_10e_custom_name_field'] ) );
				$seur_10ef_custom_name                         = sanitize_text_field( wp_unslash( $_POST['seur_10ef_custom_name_field'] ) );
				$seur_13e_custom_name                          = sanitize_text_field( wp_unslash( $_POST['seur_13e_custom_name_field'] ) );
				$seur_13f_custom_name                          = sanitize_text_field( wp_unslash( $_POST['seur_13f_custom_name_field'] ) );
				$seur_48h_custom_name                          = sanitize_text_field( wp_unslash( $_POST['seur_48h_custom_name_field'] ) );
				$seur_72h_custom_name                          = sanitize_text_field( wp_unslash( $_POST['seur_72h_custom_name_field'] ) );
				$seur_cit_custom_name                          = sanitize_text_field( wp_unslash( $_POST['seur_cit_custom_name_field'] ) );
				$seur_2SHOP_custom_name                        = sanitize_text_field( wp_unslash( $_POST['seur_2SHOP_custom_name_field'] ) );
				$seur_courier_int_aereo_paqueteria_custom_name = sanitize_text_field( wp_unslash( $_POST['seur_courier_int_aereo_paqueteria_custom_name_field'] ) );
				$seur_courier_int_aereo_documentos_custom_name = sanitize_text_field( wp_unslash( $_POST['seur_courier_int_aereo_documentos_custom_name_field'] ) );
				$seur_netexpress_int_terrestre_custom_name     = sanitize_text_field( wp_unslash( $_POST['seur_netexpress_int_terrestre_custom_name_field'] ) );
