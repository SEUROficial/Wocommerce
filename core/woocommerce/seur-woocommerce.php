...
class WC_Shipping_SEUR_Init {
	...
	public function plugin_links( $links ) {
		$plugin_links = array(
			'<a href="http://support.woothemes.com/">' . __( 'Support', SEUR_TEXTDOMAIN ) . '</a>',
			'<a href="http://wcdocs.woothemes.com/user-guide/seur/">' . __( 'Docs', SEUR_TEXTDOMAIN ) . '</a>',
		);
	...
	public function wc_deactivated() {
		echo '<div class="error"><p>' . sprintf( __( 'WooCommerce SEUR Shipping requires %s to be installed and active.', SEUR_TEXTDOMAIN ), '<a href="http://www.woothemes.com/woocommerce/" target="_blank">WooCommerce</a>' ) . '</p></div>';
	}
	...
	public function upgrade_notice() {
		...
		<div class="notice notice-success is-dismissible wc-seur-notice">
			<p><?php echo sprintf( __( 'SEUR now supports shipping zones. The zone settings were added to a new SEUR method on the "Rest of the World" Zone. See the zones %shere%s ', SEUR_TEXTDOMAIN ),'<a href="' .$zones_admin_url. '">','</a>' ); ?></p>
		</div>
