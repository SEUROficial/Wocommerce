...
function seur_metabox_callback( $post ) {
    ...
    if( ! $has_label ) {
		 ...
		 <img src="<?php echo SEUR_PLUGIN_URL; ?>assets/img/icon-96x37.png" alt="SEUR Image" width="96" height="37" />
		 <?php echo '<a href="' . $url_to_file_down . '?label=' . $label_path . '&label_name=' . $label_file_name . '&pass=' . $file_downlo_pass . '&file_type=' . $file_type . '" class="button" target="_blank">' . __( ' See SEUR Label ', SEUR_TEXTDOMAIN ) . '</a>';
