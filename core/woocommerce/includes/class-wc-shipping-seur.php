	...
	*/
	public function generate_single_select_country_html() {
		...
		<tr valign="top">
			...
			<td class="forminp">
				<select name="woocommerce_seur_origin_country_state" id="woocommerce_seur_origin_country_state" style="width: 250px;" data-placeholder="<?php _e('Choose a country&hellip;', 'woocommerce'); ?>" title="Country" class="chosen_select">
