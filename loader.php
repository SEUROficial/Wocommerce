...
define( 'SEUR_OFFICIAL_VERSION', '1.4.2.1' );
...
define( 'SEUR_POST_UPDATE_URL', 'https://seur-woo.com/2019/09/03/nueva-version-seur-1-4-2/' );
	...
	if ( $version !== SEUR_OFFICIAL_VERSION ) {
		if ( isset( $_REQUEST['seur-hide-new-version'] ) &&  'hide-new-version-seur' === $_REQUEST['seur-hide-new-version'] ) {
			...
			<div id="message" class="updated woocommerce-message woocommerce-seur-messages">
				...
				<p>
					<?php echo esc_html__( 'SEUR has been updated to version', 'woocommerce-seur' ) . ' ' . SEUR_OFFICIAL_VERSION; ?>
				</p>
				<p>
					<?php printf( __( 'Discover the improvements that have been made in this version, and how to take advantage of them <a href="%s" target="_blank">here</a>', 'woocommerce-seur' ), esc_url( SEUR_POST_UPDATE_URL ) ); ?>
				</p>
			</div>
		<?php }
	}
